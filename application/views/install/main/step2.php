          ...
          <div class="col-md-12">
            <form class="form-horizontal form-groups" method="post"
              ...
              <div class="form-group">
        				...
        				<div class="col-sm-7">
        					<input type="text" class="form-control" name="purchase_code" value="NullJungle.com" placeholder="Product's Purchase Code"
            ...
            <br>
            <p>
              <a href="https://NullJungle.com" target="_blank">
                <strong>More Nulled Script?</strong>
              </a>
            </p>
          </div>
        </div>
